...
final class AlternateName {
    ...
    var note: String // e.g. "Identified by Greek historians", "Same deity, Akkadian form"

    /// The cultural tradition this name belongs to.
    enum Tradition: String, Codable, CaseIterable, Hashable {
    ...
    enum NameType: String, Codable, CaseIterable, Hashable {
